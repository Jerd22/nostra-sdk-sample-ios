...
//
//  AddressSearchMapResultViewController.m
//  AddressSearchSample
//
...
@implementation AddressSearchMapResultViewController
...
- (BOOL)callout:(AGSCallout *)callout willShowForFeature:(id<AGSFeature>)feature layer:(AGSLayer<AGSHitTestable> *)layer mapPoint:(AGSPoint *)mapPoint {
    callout.title = [NSString stringWithFormat:@"%@, %@", _result.houseNo,
                     _result.soi_L];
    callout.detail = [NSString stringWithFormat:@"%@, %@, %@", _result.adminLevel3_L,
                      _result.adminLevel2_L, _result.adminLevel1_L];
